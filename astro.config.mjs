            ...
            if (lang && lang !== "plaintext") {
              ...
              if (icon) {
                const svgProps = {
                  ...
                  className: ["code-label-icon", `code-label-icon-${lang}`],
                };
                let svgChildren;
                if (icon.d) {
                  svgProps.fill = icon.fill;
                  svgChildren = [
                    {
                      type: "element",
                      tagName: "path",
                  ...
                  svgProps.fill = icon.fill;
                  svgProps.stroke = icon.stroke;
                  svgProps.strokeWidth = icon.strokeWidth;
                  svgProps.strokeLinecap = "round";
                  svgProps.strokeLinejoin = "round";
                  svgChildren = icon.paths.map((p) => {
                    const { tag, ...attrs } = p;
                    return {
                      type: "element",
                      tagName: tag,
