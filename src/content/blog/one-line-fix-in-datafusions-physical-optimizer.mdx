...
description: "One optimizer pass was silently destroying work that another depended on. The fix was a single guard clause — and the speedup was an order of magnitude."
date: 2026-03-22
